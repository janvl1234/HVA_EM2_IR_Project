...
module top ;
	...
	wire [0:0] tmpOE__Pin_IR_net;
	wire [0:0] tmpFB_0__Pin_IR_net;
	wire [0:0] tmpIO_0__Pin_IR_net;
	wire [0:0] tmpINTERRUPT_0__Pin_IR_net;
	electrical [0:0] tmpSIOVREF__Pin_IR_net;

	cy_psoc3_pins_v1_10
		#(.id("86dd0397-61da-496f-a8e3-b48257fdbabf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_IR
		 (.oe(tmpOE__Pin_IR_net),
		  .y({Net_1066}),
		  .fb({tmpFB_0__Pin_IR_net[0:0]}),
		  .io({tmpIO_0__Pin_IR_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_IR_net),
		  .interrupt({tmpINTERRUPT_0__Pin_IR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_IR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_960 = 1'h0;


	cy_clock_v1_0
		#(.id("6407e946-9b83-4a6b-955a-5cc36f765576"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1388888888.88889"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_1
		 (.clock_out(Net_865));
    ...
    assign Net_1066 = Net_1064 & Net_1065;
